...
2. **Lesson**
   * Go over part 1 of the Do Now. 
     * Discuss the output of the program - were the students able to guess the output without typing it?
       * Go over how to read for loops if students are struggling \(drawing the [loop diagram](http://etutorials.org/shared/images/tutorials/tutorial_169/F05um02.jpg)\). Make sure students are understanding loops and string concatenation. 
   ...
   * Go over part 2 of the Do Now. 
     ...
     * Draw a diagram \(**stack trace**\) of the for loop \(e.g. something like [loop diagram](http://etutorials.org/shared/images/tutorials/tutorial_169/F05um02.jpg)\) 
