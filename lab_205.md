...
3. Create a basic college quiz game using lists. In this quiz game each index represents a college that the user should apply to. Each of the answers in that index 
